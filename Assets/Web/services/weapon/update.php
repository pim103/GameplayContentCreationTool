...
{
    $success = WeaponDAO::updateWeapon(intval($_POST["id"]), $_POST["weaponName"], intval($_POST["damages"]), floatval($_POST["rateOfFire"]), intval($_POST["projSpeed"]), intval($_POST["projLifeTime"]), intval($_POST["modelId"]), intval($_POST["effectId"]));
    if ($success)
    {
